...
void MakeL1TurnOnPlots(char* filename, int key) {
    ...
    TCut matchL1 = "passhltL1VBFDiJetIsoTau>0 && matchedL1Jets>0"; 
    ...
    if (key == 0) {
      TH1F* h_t1TOnum = new TH1F("h_t1TOnum", "", 15, 0, 150); // t1TOnum is t1_pt Turn-On Numerator
    ...
    if (key == 1) {
      TH1F* h_t2TOnum = new TH1F("h_t2TOnum", "", 10, 0, 100); // t2TOnum is t2_pt Turn-On Numerator
    ...
    if (key == 2) {
      TH1F* h_j1TOnum = new TH1F("h_j1TOnum", "", 15, 0, 300); // j1TOnum is j1_pt Turn-On Numerator
      TH1F* h_j1TOdem = new TH1F("h_j1TOdem", "", 15, 0, 300);
      TH1F* h_j1TOratio = new TH1F("h_j1TOratio", "", 15, 0, 300);
    ...
    if (key == 3) {
      TH1F* h_j2TOnum = new TH1F("h_j2TOnum", "", 15, 0, 150); // j2TOnum is j2_pt Turn-On Numerator
    ...
    if (key == 5) {
      ...
      h_j1TOratio->SetTitle("odd Turn-On Plot");
      h_j1TOratio->Draw("E");
      h_j1TOratio->GetYaxis()->SetRangeUser(0.,1.1);
