...
config.JobType.psetName = 'hltDummy_AllUnprescaledL1s.py'
...
config.Site.whitelist = ['T2_CH_CSCS','T1_US_FNAL', 'T2_FR_GRIF_LLR', 'T2_HU_Budapest', 'T3_US_FNALLPC'] #if submit user-data, exclude HU and GRIF
...
#config.Data.outputPrimaryDataset = 'EZB1_FourRuns_dummyHLT'
