# hltGetConfiguration /users/ballmond/DummyHLT/V1 --globaltag auto:run3_hlt --path HLTriggerFirstPath,HLT_Dummy_v1,HLTriggerFinalPath,HLTAnalyzerEndpath --data --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2018Input --unprescale --output none --process MYOTHERHLT --full --offline --max-events 100 --l1Xml L1Menu_Collisions2022_v0_1_1_modified_updated_Nov30.xml --input file:output_dummy_otherL1.root
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:output_dummy_otherL1.root',
    ),
...
_customInfo['inputFile' ]=  ['file:output_dummy.root']
